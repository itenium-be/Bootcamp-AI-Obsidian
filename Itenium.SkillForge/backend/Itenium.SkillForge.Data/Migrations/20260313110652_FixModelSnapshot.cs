...
namespace Itenium.SkillForge.Data.Migrations
{
    ...
    public partial class FixModelSnapshot : Migration
    {
        ...
        {
            // No-op: tables already exist from ResourcesAndLiveSession (hand-crafted migration).
            // This migration exists only to synchronise AppDbContextModelSnapshot with the current model.
        }
        ...
        private void _unused(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelDescriptorsJson = table.Column<string>(type: "text", nullable: false),
        ...
        private void _unusedDown(MigrationBuilder migrationBuilder)
        {
