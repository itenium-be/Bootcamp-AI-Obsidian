...
- Content Management
    ...
    - As team manager, I want to structure courses into modules and lessons.
...
- Feedback
    ...
    - As a learner, I want to provide course feedback, so content can improve.
    - As backoffice, I want to review learner feedback per course.
- Certification
    - As a learner, I want to receive a certificate when I complete a course.
    - As backoffice, I want to define certificate templates.
